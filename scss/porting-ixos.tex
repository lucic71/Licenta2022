...
\todo{add intro: present a summary of what will we discuss in this section}
...
\begin{figure*}
    ...
    \caption{Initial IxOS architecture \todo{modify this diagram as discussed}}
...
\todo{talk about the code structure: written in c++, classes, modularity}
...
\todo{i might want to elaborate a bit more here. note that in the new
environment we also had to install tools, create pipes and install needed shared
libraries for ixstack}
...
\end{itemize}
\todo{should i mention the performance testing? maybe}
...
\todo{these stages and subtstages need a rename as they are too specific and
would take too much ot introduce the whole context}
\begin{itemize}
...
Interface Manager \todo{Interface Manager or InterfaceManager} and HostProxy, which were the building block of our porting,
...
environment and the target environment. \todo{i dont like this sentence} For that we had to hack some parts of
