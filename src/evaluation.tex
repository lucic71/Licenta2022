...
\chapter{Porting Costs Evaluation} \label{sec:eval}

\lm{I would totally rename this to ``Evaluation of Porting Costs''. Dunno, it just sounds more natural to me.}
...
\lm{Returning here after I've reviewed the entire chapter, I think there is a lot that you could say in this first introductory paragraph, you could even describe the chapter using multiple paragraphs. This is a long chapter, it says a lot of things, so don't be afraid of spelling all of them out in a summary here.}
...
to clarify the system.~\lm{We tried, but did we succeed? If you say whether the discussions actually helped clarify e.g. misunderstandings about how the system works, then this might shed some more light on how some of the issues were resolved.}
...
\lm{In my opinion this is perfect.}
...
InterfaceManager.~\lm{IMHO these issues should also be explicitly mentioned in the implementation section.}
...
\lm{Not sure if it would look nicer if you used {\textbackslash}paragraph here instead of {\textbackslash}textit. Could give it a try.}
...
familiarize with its functions and structures, therefore I~\lm{I think this is the first time you use singular first-person.} had no experience
...
\lm{Maybe an example of particular environmental issues would work here?}
