...
in terms of portability. One must answer the following questions regarding to
...
possible? For example, device I/O control in Windows is achieved through DeviceIoControl while Unix
systems use ioctl.
Compiler portability can also become problematic as not all compilers accept the same language.
What are the constructs specific only to this type or version of compiler? Should I use preprocessor
