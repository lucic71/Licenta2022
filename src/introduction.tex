...
\lm{Need to render chapters in English, i.e.
``Chapter 1'' instead of ``Capitolul 1'').}

\lm{Need to translate \texttt{section}s into \texttt{chapter}s,
\texttt{subsection}s into \texttt{section}s
and so on and so forth,
to make this look like a thesis instead of a paper.}
