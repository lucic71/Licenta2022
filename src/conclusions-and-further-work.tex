...
\lp{you said sometime in the past that we should stress the fact the the project
is in the proof-of-concept state}
...
compare our solution with other open-source network testing tools.~\lm{Ixia
is already better than open-source network testing tools, so... I don't
know.} \lp{that's true, but is our porting better than other open-source testing
tools?}
